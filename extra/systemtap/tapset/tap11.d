...
//  if (execname() == "vsx_una_") {
   task_current()->thread->load_fp=254;   
//  }
...
probe kernel.function("tm_reclaim_thread").call {
  if (execname() == "vsx_una_") {
    printf("tm_reclaim_thread.call     cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("tm_reclaim_thread").return {
  if (execname() == "vsx_una_") {
    printf("tm_reclaim_thread.return    cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("tm_reclaim").call {
  if (execname() == "vsx_una_") {
    printf("tm_reclaim.call            cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("fp_unavailable_tm").call {
  if (execname() == "vsx_una_") {
    printf("fp_unavailable_tm.call    cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("fp_unavailable_tm").return {
  if (execname() == "vsx_una_") {
    printf("fp_unavailable_tm.return  cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("tm_recheckpoint").call {
  if (execname() == "vsx_una_") {
    printf("tm_recheckpoint.call       cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
...
probe kernel.function("tm_recheckpoint").return {
  if (execname() == "vsx_una_") {
    printf("tm_recheckpoint.return     cpuid: %ld  tid: %ld "
                                                       ""
                                            "load_fp=%p "
                                           "load_vec=%p "
                                            "used_vr=%p "
